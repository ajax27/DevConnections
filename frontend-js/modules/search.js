...
export default class Search {
  // Select DOM elements and keep track of usefull data
  constructor() {
  ...
  renderResultsHTML(posts) {
    if (posts.length) {
      ...
      this.resultsArea.innerHTML = `<p class="alert alert-danger text-center shadow-sm">Sorry, we could not find any results for your search!</p>`;
    }
    this.hideLoaderIcon();
  ...
  injectHTML() {
    ...
    <div class="search-overlay-top shadow-sm">
      <div class="container container--narrow">
        ...
        <input type="text" id="live-search-field" class="live-search-field" placeholder="What can I find for you?">
